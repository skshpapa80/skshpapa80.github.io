...
<p align="center"><a href="/assets/images/androoid_1.png" id="open-image"><img src="/assets/images/androoid_1.png" alt="로그인 페이지" width="300"/></a></p>

JSP를 사용한 이유는 기존 웹계정에 올려야 하는데 그 웹 시스템이 Spring로 되어 있어서 JSP를 사용하게 되었습니다. 
그때에는 Spring를 할줄 몰랐거든요 그래서 JSP 로 만들었습니다. 

<p align="center"><a href="/assets/images/androoid_2.png" id="open-image"><img src="/assets/images/androoid_2.png" alt="금형 상세 조회(위치관리 포함)" width="300"/></a></p>

<p align="center"><a href="/assets/images/androoid_3.png" id="open-image"><img src="/assets/images/androoid_3.png" alt="금형 RFID 태그 등록 페이지" width="300"/></a></p>
