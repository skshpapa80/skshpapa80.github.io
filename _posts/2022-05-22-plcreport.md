...
그리고 그 CSV 값을 조회하는 프로그램도 만들고요. 나중에 PLC 어드레스가 바뀔 경우 프로그램 수정하면 귀찮을 거 같아서 어드레스를 INI에 저장해 놓고 불러다 사용하게 만들었습니다. 물론 PLC 주요 어드레스는 코딩으로 처리했고요.
