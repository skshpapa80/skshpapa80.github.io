...
* 1.대학교 축제 전시 프로젝트
  ...
  - [https://skshpapa80.iwinv.net/1-university-festival-exhibition-project/](https://skshpapa80.iwinv.net/1-university-festival-exhibition-project/)
* 2.CD-ROM 에서 동작하는 이미지 뷰어 만들기
  - 첫 업무 기존 개발자가 개발한 프로그램 수정
  - [https://skshpapa80.iwinv.net/2-cd-rom-image-viewer/](https://skshpapa80.iwinv.net/2-cd-rom-image-viewer/)
* 3.도면 뷰어 프로그램 수정
  - 기존 컴포넌트(Dr.DWG) -> OpenDWG.Viewkit 으로 변경(델마당 자료 사용)
  - [https://skshpapa80.iwinv.net/3-dwg-viewer-change/](https://skshpapa80.iwinv.net/3-dwg-viewer-change/)
* 4.졸업작품 – ASP 웹사이트 만들기
  - ASP로 커플관리 사이트 만들기
  - [https://skshpapa80.iwinv.net/4-graduation-project-asp-web/](https://skshpapa80.iwinv.net/4-graduation-project-asp-web/)
* 5.지하철 표지판 관리 프로그램 (미완성)
  - 지하철에 표지판을 관리하는 방식을 만드는 프로젝트
  - [https://skshpapa80.iwinv.net/5-subway-sign-project/](https://skshpapa80.iwinv.net/5-subway-sign-project/)
* 6.도면 뷰어 컴포넌트 교체기
  - OpenDWG.Viewkit 으로 개발한 컴포넌트를 CAD Import VCL 로 변경
  - [https://skshpapa80.iwinv.net/6-dwg-component-change/](https://skshpapa80.iwinv.net/6-dwg-component-change/)
* 7.제적부 색인 프로젝트
  - 오래된 제적부 스캔 후 인덱스 입력하는 프로그램 개발 및 XML 변환
  - [https://skshpapa80.iwinv.net/7-oldpaper-index-project/](https://skshpapa80.iwinv.net/7-oldpaper-index-project/)
* 8.이미지 보정 프로그램
  - 스캔 받은 이미지(tiff) 보정하는 프로그램
  - [https://skshpapa80.iwinv.net/8-image-edit-program/](https://skshpapa80.iwinv.net/8-image-edit-program/)
* 9.Codeigniter Web 개발 아르바이트
  - 2018년 지인의 요청으로 하게 된 Web 개발 아르바이트 입니다.
  - [https://skshpapa80.iwinv.net/9-codeigniter-web-dev/](https://skshpapa80.iwinv.net/9-codeigniter-web-dev/)
* 장비제어용 페이지 모바일용 반응형웹
...
* 2005년 PSP용 음악플레이어
  ...
  - [https://skshpapa80.iwinv.net/2005-psp-musicplayer/](https://skshpapa80.iwinv.net/2005-psp-musicplayer/)
...
* 사진 정리 프로그램(Photodate)
  ...
  - [https://skshpapa80.iwinv.net/photodate/](https://skshpapa80.iwinv.net/photodate/)
* 자작 프로그램 – 이미지 뷰어 만들기
  - 델파이(Delphi)로 만든 이미지 뷰어
  - [https://skshpapa80.iwinv.net/homebrew-image-viewer/](https://skshpapa80.iwinv.net/homebrew-image-viewer/)
* Sheet2DB 
  - Excel 파일을 좀 쉽게 DB(MSSQL) 에 넣어 보자고 작은 아이디어
  - [https://skshpapa80.iwinv.net/sheet2db-excel-db-upload/](https://skshpapa80.iwinv.net/sheet2db-excel-db-upload/)
* SmallPlayer
  - 동영상 플레이어 DirectShow
  - [https://skshpapa80.iwinv.net/smallplayer-movie-player/](https://skshpapa80.iwinv.net/smallplayer-movie-player/)
* LZBasePlayer
  - Lazarus 로 만든 DirectShow, Lav filter 동영상 플레이어 
  - [https://skshpapa80.iwinv.net/lzbaseplayer-directshow/](https://skshpapa80.iwinv.net/lzbaseplayer-directshow/)
